...
content = content.replace('SK Community Base - Admin', 'SK Community Base - Admin')
content = content.replace('<title>Admin Dashboard - SK Community Base</title>', '<title>Admin Dashboard - SK Community Base</title>')
